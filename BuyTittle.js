          ...
          <div className="w-full lg:w-[61%] py-4">
            <div className="flex flex-col gap-y-5">
              ...
              <div className='flex gap-x-2'>
                <h1 className="text-2xl text-black hidden lg:block font font-semibold">Rs {Data.salePrice}</h1>
                <h1 className="text-xl text-gray-600 hidden line-through lg:block font font-semibold">Rs {Data.price}</h1>
              </div>
            ...
            <div className="flex pt-4 gap-x-10">
              {/* <div className="flex" >
                <h1 className="border cursor-pointer px-3 py-1 font-semibold " onClick={decrement}>-</h1>
                <h1 className="border  px-2 py-1">{add}</h1>
                <h1 className="border cursor-pointer px-3 py-1" onClick={increment}>+</h1>
              </div> */}
              <button
